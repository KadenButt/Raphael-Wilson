...
<html lang="en">
  ...
  <style>
    ...
    /* Dark mode override for navigation */
...
<body>
  <header id="navigation">
    ...
    <div class="right-section">
      ...
      <!-- Dark Mode Toggle with consistent styling -->
      <button id="themeToggleBtn" style="margin-left: 10px; padding: 10px; border: none; border-radius: 5px; cursor: pointer; background-color: #fff; color: #000; font-weight: bold;">
        Toggle Dark Mode
      </button>
    </div>
  </header>
