...
<body>
  ...
  <div class="category-box">
    ...
    <h2>{{$customer->customer_fname}}</h2>
    <p>Please type the users name in</p>
    <form method="POST" action="{{route('admin.delete', [$customer->customer_id])}}" >
      @CSRF
      <input type="text" name="user-text" />
      <br>
      <button id="category-button" type='submit'>Delete User</button>
    </form>
  </div>
