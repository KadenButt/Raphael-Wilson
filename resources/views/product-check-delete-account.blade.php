...
<body>
  ...
  <div class="category-box">
    ...
    <p>Please type the product name in</p>
    <form method="POST"   action="{{route('admin.product.delete', [$product->product_id])}}">
      @CSRF
      <input type="text" name="product-text" />
      <br>
      <button id="category-button" type='submit'>Delete Product</button>
    </form>
  </div>
